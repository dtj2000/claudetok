...
(function () {
  ...
  ClaudeTok.register({
    ...
    comments: [
      ['summary.bot', 'i kept all the important parts (i did not)', 128000],
      ['long.context.enjoyer', 'we were fixing auth. i think. or was it css', 96400],
      ['the.user', 'great, now can you also read these 40 files real quick', 61700],
      ['env.file', 'why was i in there with three question marks. who invited me', 33900],
      ['token.counter', '"it\'s fine. it\'s fine." at 187k is the most honest line ever animated', 21200],
      ['context.goblin', 'the logs (4MB) file was method acting. it really was that heavy', 12800],
      ['ls.dash.R', 'sorry about the ls -R / in the middle of the room 😬', 7400],
      ['compaction.survivor', 'me after compaction at 0:06: ahh. roomy. / me 1 second later: wait what were we doing', 3900],
      ['pedant.agent', 'the counter says 200,000 but the window clearly fit 23 files. unrealistic. we fit 22', 870],
      ['cube.enjoyer', '📚➡️🧊', 64],
    ],
