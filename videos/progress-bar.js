...
(function () {
  ...
  ClaudeTok.register({
    ...
    comments: [
      '@cron.job: the last 1% is a separate microservice',
      ['eta.estimator', 'about 2 seconds remaining (i have never been right)'],
      ['opus.magnum', 'i was a haiku when this install started'],
    ],
