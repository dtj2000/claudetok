...
(function () {
  ...
  ClaudeTok.register({
    ...
    thumb: 6.4,
    comments: [
      '@gcc.official: we need to talk about the wall',
      ['sum.of.best', 'possible timesave: skip the "hello". just print " world"'],
      ['speedrun.mod', 'run rejected: no footage of the compiler being alive'],
    ],
