...
(function () {
  ...
  ClaudeTok.register({
    ...
    thumb: 5.4,
    comments: [
      ['eslint', 'i have been trying to tell you about that ; for 3 hours', 214000],
      ['senior.dev', 'best code reviewer on the team. also takes backspace privileges seriously', 162000],
      ['claude', 'i would have added it but you said "don\'t touch anything else" 🥲', 118000],
      ['the.backspace.key', '0:07 he stepped on me on his way out and i will never forgive myself', 66300],
      ['cat.tax', 'he did this in one take. he does it every time. i have 40 builds failing', 34700],
      ['feed.cat.fn', 'the function is literally called feedCat and returns "tuna". he was fixing it for himself', 18900],
      ['python.dev', 'me with no semicolons watching this like 👁️👄👁️', 8200],
      ['build.status', '✗ → ✓ → ✗ in 3 seconds. that cat is a whole CI pipeline', 3100],
      ['whisker.lint', 'the paw tap has a DING on it. this is the best sound design on the app', 870],
      ['keyboard.warmer', '😼;', 64],
    ],
