...
(function () {
  ...
  ClaudeTok.register({
    ...
    comments: [
      '@flaky.test: i am the reason the whale takes 45 minutes to surface',
      ['yaml.sailor', 'my pipeline has been lost at sea since a missing indent in 2019'],
      ['release.manager', 'we do not deploy on fridays, matey 🏴‍☠️'],
    ],
