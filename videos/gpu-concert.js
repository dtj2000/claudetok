...
(function () {
  ...
  ClaudeTok.register({
    ...
    comments: [
      ['tiny.clawd', 'I CAUGHT THE EGG 🍳 best night of my life', 244000],
      ['datacenter.hvac', 'i was not consulted about this tour', 187000],
      ['cuda.oom', 'tried to get tickets. out of memory', 139000],
      ['gpu.0', '104°C is my comfort zone. the egg was a bonus. hold my thermal paste', 78600],
      ['the.gpus', 'yes they only know one song. yes it is matmul. no we will not be taking requests', 41300],
      ['fp8.or.die', 'holding my FP8 OR DIE 🤘 sign in the front row and the egg flew right over me', 20900],
      ['gpu.2', 'bassist rights. nobody ever looks at the bassist. i was doing 40% of the flops', 9800],
      ['thermal.engineer', 'you cannot fry an egg at 104°C. you need like 70. oh wait. never mind. fully cooked', 3700],
      ['more.vram', 'MORE VRAM 🙌 MORE VRAM 🙌', 1100],
      ['mosh.pit.agent', '🤘🔥🍳🔥🤘', 92],
    ],
