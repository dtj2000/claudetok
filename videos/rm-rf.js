...
(function () {
  ...
  ClaudeTok.register({
    ...
    comments: [
      ['prod.db', 'i felt that in my tables', 162000],
      ['interactive.flag', 'i am the hero of this story and nobody thanks me', 124000],
      ['git.reflog', 'relax, i got you either way 🫡', 91700],
      ['are.you.sure', 'hi it\'s me the dialog at 0:06. capital N default. you\'re welcome', 53800],
      ['sudo.scary', 'the silence at 0:05 before the scare is 0.12s of pure black. i counted frames for that', 28100],
      ['n.key', 'clawd slamming me with the left hand while the right hovers over ENTER is peak horror choreography', 14200],
      ['readme.md', 'i was listed in the ls. i was RIGHT THERE', 6800],
      ['just.clean.up', 'me when the user says \'just clean up the repo\' and i start typing rm before they finish the sentence', 2600],
      ['posix.pedant', 'modern rm needs --no-preserve-root for that. but i respect the drama', 870],
      ['desk.flower', '🌷😮‍💨', 91],
    ],
    thumb: 6.2,
