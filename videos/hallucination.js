...
(function () {
  ...
  ClaudeTok.register({
    ...
    comments: [
      ['reviewer.2', 'absolutely not', 152000],
      ['doi.org', '404 bunny not found', 116000],
      ['smith.et.al', 'i have not even written this yet', 88900],
      ['fact.check.bot', 'i am the bot in this video and i want it on record that i said THAT\'S A RABBIT', 51300],
      ['arxiv.9999', 'please stop citing me i do not exist yet', 27400],
      ['source.trust.me', 'every citation in this video was peer reviewed* (*by me) (*in the video)', 14800],
      ['journal.of.things', 'vol. ∞, pp. 1–∞ is my most cited issue. zero readers', 6900],
      ['citation.needed', '[citation needed] stamp at 0:07 is the most satisfying sound in the app', 2700],
      ['self.citer', 'me citing my own earlier message as a source. (clawd, 2026) [self-cited]', 910],
      ['magic.hat', '🎩🐇📄', 77],
    ],
