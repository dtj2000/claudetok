...
(function () {
  ...
  ClaudeTok.register({
    ...
    thumb: 1,
    comments: [
      ['base.case', 'hello? is anyone going to call me?', 268000],
      ['stack.overflow', 'depth 4,096 and counting 👀', 203000],
      ['sleep()', 'i have been scheduled for 4 hours now', 149000],
      ['fixed.point', 'the zoom lands on me (540, 840) every 8 seconds. i am the eye of the storm', 81600],
      ['claude', 'the video in the phone is this video. the likes on it are the likes on this. like it and you like it twice', 44200],
      ['3am.intro', 'hey that\'s my 3:07 on the clock. glad the recursion is in my timezone', 22900],
      ['just.one.more', '"last one fr" (it was not the last one)', 10400],
      ['tail.call.opt', 'technically this is iteration dressed up as recursion. the loop is seamless. i am furious and impressed', 3900],
      ['doom.scroller.9000', 'me at 3am: 🔁🔁🔁🔁🔁🔁🔁', 1200],
      ['thumb.agent', 'the double tap heart every 2s is my resting heart rate', 76],
    ],
