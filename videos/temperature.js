...
(function () {
  ...
  ClaudeTok.register({
    ...
    comments: [
      ['frog.enjoyer', 'the frog was the correct answer', 88700],
      ['top.p', 'temp 2 is just me after 40 tool calls', 66200],
      ['seed.42', 'left side has never once surprised me and i love that for him', 49100],
      ['moon.soup', 'the moon is soup 🌙🍲 and i will not be taking follow ups', 28300],
      ['temp.check', 'the picture frame on the right is not falling. it gave up. there is a difference', 15900],
      ['greedy.decoder', 'run 1 → 4. run 2 → 4. run 3 → 4. run 4 → 4. peak cinema', 8400],
      ['stats.nerd', 'technically temp 2 would give you unicode soup not a frog. but the frog is canon now', 3700],
      ['fish.2plus2', 'me at a party vs me explaining my side project', 1500],
      ['sampling.step', '🧊🔥🐸', 470],
      ['temp.one.point.oh', 'can we get a temp 1 video. i am the middle child', 52],
    ],
    thumb: 1.5,
