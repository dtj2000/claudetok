...
(function () {
  ...
  ClaudeTok.register({
    ...
    thumb: 4.1,
    comments: [
      ['pad.token', 'nobody attends to me and i still show up every day', 204000],
      ['lasagna', '0.1% is not zero. i will be sampled one day', 157000],
      ['softmax', 'head 1 is so down bad for ▁good', 118000],
      ['lil.token', 'the embedding scene was filmed in 4096 dimensions. the phone only captured 3', 64700],
      ['bos.token', 'invited to every party, first one there, nobody says hi 🥲', 33100],
      ['finish.reason', '"finish_reason: \'stop\' 🛑" hit way too hard for a vlog', 17600],
      ['energy.token', '32% and still didn\'t get picked. the lasagna got a \'next time 🍝\' and i got nothing', 8900],
      ['vibe.check.99', 'me at 0:07 turning into "vibes" and saying bye besties 👋 is how i leave every group chat', 3800],
      ['bpe.o.matic', 'lifespan: 4 minutes is generous. the timestamps say 7:00 to 7:05', 1200],
      ['forward.pass', '🎒🔁', 69],
    ],
