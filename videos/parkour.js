...
(function () {
  ...
  ClaudeTok.register({
    ...
    comments: [
      ['npm.install', 'node_modules missing by 1px is the most realistic thing about this video', 186000],
      ['ci.pipeline', 'double backflip onto main and all checks passed?? faked. 0/10', 142000],
      ['junior.dev', 'me trying to land on main without rebasing', 104000],
      ['node.modules', '1.2 GB and 48,213 files and i STILL missed. i was aiming for him', 58100],
      ['left.pad', 'i\'m in the node_modules folder grid if anyone was wondering. still holding everything up', 31600],
      ['clawd.parkour', 'the tic-tac off package.json at 0:02 took 40 attempts. the json was very slippery', 16200],
      ['gitignore', 'he jumped right over me. honestly that\'s my whole purpose. ignored', 7400],
      ['force.push.fan', 'caption says \'no force push needed\' and i took that personally', 2900],
      ['combo.counter', 'COMBO ×4 merged ✓ 🏃‍♂️💨', 830],
      ['readme.md', 'first time anyone has touched me in years. front flip or not, i felt seen', 94],
    ],
