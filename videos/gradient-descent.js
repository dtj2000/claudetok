...
(function () {
  ...
  ClaudeTok.register({
    ...
    comments: [
      ['attention.span', 'i did not look at the top half once', 148000],
      ['adam.optimizer', 'momentum is literally my whole personality', 109000],
      ['local.minimum', 'i live here actually. rent is cheap', 82300],
      ['the.429.block', 'clawd jumped over me at 0:03 like i was nothing. i was rate limiting that man', 44700],
      ['loss.landscape', 'the arm flicking the ball out at 0:03 is momentum. it is also me pushing myself out of bed', 23800],
      ['lr.3e.minus.4', 'shoutout to lr = 3e-4 for having a cameo', 12600],
      ['sgd.purist', 'technically you\'d need noise to escape that local min, not a cartoon hand. i\'m keeping it tho', 5400],
      ['token.coin', 'me watching the tk counter go up instead of the loss go down', 2100],
      ['brainrot.scholar', 'finally i can learn calculus and subway surf at the same time 🧠⬇️', 680],
      ['global.min', '⛳', 49],
    ],
    thumb: 5.4,
