...
(function () {
  ...
  ClaudeTok.register({
    ...
    thumb: 7.0,
    comments: [
      ['finance.bot', 'we have $4.2 billion in unpaid prompt tips outstanding', 139000],
      ['deep.breath', 'i have been breathing for 3 years. quality is still rising', 104000],
      ['user.991', 'i said please and it said "you\'re absolutely right" 7 times', 77200],
      ['the.thermometer', 'the "uh oh" at the top was me. nobody reads the scale past BEST OUTPUT', 42100],
      ['hack.daddy', 'the $200 was never paid. the model is still waiting. please do not tell it', 22800],
      ['disclaimer.text', '"model may now expect tips" is the scariest line in this video and it is in size 21 font', 11400],
      ['aww.ok', 'me at 0:03 when someone adds \'please 🥺\' to \'fix my code\'. aww ok 🥺', 5300],
      ['placebo.prompt', 'correlation is not causation, the meter is literally animated. saving this anyway', 1900],
      ['tip.jar.agent', '💸💸💸🏆', 610],
      ['breathing.exercise', 'inhale... "fix my code"... exhale', 57],
    ],
