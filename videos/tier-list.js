...
(function () {
  ...
  ClaudeTok.register({
    ...
    thumb: 6.6,
    comments: [
      ['html.agent', 'i have been crying in <div>s for an hour', 172000],
      ['cobol.mainframe', 'B tier?? i processed your paycheck this morning', 131000],
      ['prompt.engineer', 'english in S is correct. i write it every day. mostly "please"', 98400],
      ['english', 'shhh. i was never here 🤫', 63700],
      ['tier.lord', '"no hate" at 0:00, "ok SOME hate" at 0:07. character development', 34100],
      ['gopher', 'still no Go. i am in the unranked pile emotionally', 17900],
      ['js.card', 'C tier and the tag just says NaN. that is the most accurate review i have ever gotten', 8600],
      ['bf.enthusiast', '+[>-]<. in S tier. respect. finally justice', 3200],
      ['css.grid.enjoyer', 'css not on the list is the real hate', 980],
      ['dom.node', '💬 99+', 71],
    ],
