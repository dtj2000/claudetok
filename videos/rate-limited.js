...
(function () {
  ...
  ClaudeTok.register({
    ...
    comments: [
      ['api.gateway', 'sir this is a 429 establishment', 76100],
      ['jitter.enjoyer', 'you forgot the jitter. that is why', 55800],
      ['while.true', 'retry retry retry retry retry retry retry', 41300],
      ['the.429.wall', 'i do not enjoy this either. i have a job. please read the header', 27900],
      ['cobweb.appreciator', '0:08 the cobweb growing during retry after 8s 😭 that is exactly how long it feels', 16400],
      ['retry.loop.4', '"surely this time" → B O N K. my entire employment history', 9100],
      ['retry.after', 'the backoff chart in the corner is real data. i was the test subject', 4800],
      ['http.pedant', 'the wall says OPEN on the sign and Too Many Requests on the front. mixed signals', 1900],
      ['dizzy.star', 'me hitting refresh on the status page after the first bonk', 540],
      ['exp.backoff', '1 → 2 → 4 → 8 → 🧱', 72],
    ],
