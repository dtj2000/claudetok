...
(function () {
  ...
  ClaudeTok.register({
    ...
    comments: [
      ['left.pad', 'i am 11 lines and i am holding up this entire galaxy', 162000],
      ['npm.audit', 'found 69 vulnerabilities (nice) (not nice)', 121000],
      ['disk.space', 'i felt this one physically', 88400],
      ['is.even', 'is-odd got sucked in first and i followed out of loyalty', 49700],
      ['heaviest.object', 'the GB counter going to ∞ was the only honest number in this video', 26100],
      ['i.heart.js.laptop', 'me going into the event horizon with my sticker still on. no regrets', 13600],
      ['astro.pedant', 'a black hole with a smug face is not how gravitational lensing works. the face is correct though', 5900],
      ['rm.rf.and.reinstall', 'the fix at the end is "$ rm -rf node_modules && npm install" and that\'s how you know this is a documentary', 2300],
      ['transitive.dep', '"i am NOT a transitive dependency" is what they all say', 780],
      ['black.hole.gulp', '🕳️📦📦📦', 64],
    ],
