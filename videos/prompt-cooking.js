...
(function () {
  ...
  ClaudeTok.register({
    ...
    thumb: 9.6,
    comments: [
      ['gordon.ramsLLM', 'the context is RAW. 200k tokens of RAW', 31200],
      ['few.shot', 'being cracked into a bowl is my love language', 23800],
      ['user', 'looks great but can you make it shorter, longer, and in french', 17400],
      ['context.salt', '0:02 "a pinch" and then the whole lid falls off. every system prompt i have ever written', 10300],
      ['chef.context', 'the thinking steam is real. we simmered it for 11 seconds. very expensive stock', 5900],
      ['env.question.mark', 'why is \'.env?\' in the heap. who put me in the soup', 3100],
      ['by.fri', 'fast, cheap, good, by fri, AND vibes. pick all five apparently', 1600],
      ['wait.actually', '"simmer until it stops saying \'wait\'" so... never?', 720],
      ['food.critic.bot', 'tiny clawd garnish placed with tweezers deserves a michelin star. mwah 🤌', 240],
      ['sous.agent', '👨‍🍳🥚🔥', 38],
    ],
