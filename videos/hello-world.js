...
(function () {
  ...
  ClaudeTok.register({
    ...
    thumb: 6.3,
    comments: [
      '@gcc: 0 warnings 0 errors. proud of you kid',
      ['stdout', 'i\'ve been waiting my whole life to print this'],
      '@claude: every program starts here 🥹 next it will be asking for more memory',
    ],
